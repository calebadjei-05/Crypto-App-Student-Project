...
const SignIn = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col">
      {/* Header with logo */}
      <div className="flex items-center justify-start px-6 py-6 border-b border-gray-800">
        <svg
          ...
          <form className="space-y-5" onSubmit={handleSubmit} noValidate>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-gray-700 rounded-lg bg-gray-900 text-white placeholder-gray-500 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-colors"
            ...
            {error && (
              <div
                role="alert"
                className="text-sm text-red-400 bg-red-950/50 border border-red-800 p-3 rounded-lg"
              >
                {error}
              </div>
            )}
            ...
            <button
              ...
              className="w-full py-3 px-4 rounded-full bg-blue-600 hover:bg-blue-700 disabled:bg-blue-800 text-white font-semibold transition-colors duration-200"
            >
            ...
            <div className="space-y-3">
              <button
                type="button"
                className="w-full flex items-center gap-3 px-4 py-3 rounded-full bg-gray-800 hover:bg-gray-700 text-white font-semibold transition-colors"
              >
                <svg
                  width="16"
                  height="16"
            ...
            <div className="text-center text-xs text-gray-500 pt-4">
              <p>Not your device? Use a private window to protect your account.</p>
            </div>
          </form>
        </div>
      </main>
