...
const NavBar = () => {
  ...
  // sections
  const navSections = [
    { name: "Cryptocurrencies", component: null, path: "/explore" },
    { name: "Individuals", component: <IndividualsDropdown />, path: null },
    { name: "Business", component: <BusinessDropDown />, path: null },
    { name: "Institutions", component: <InstitutionsDropdown />, path: null },
    { name: "Developers", component: <DeveloperDropDown />, path: null },
    { name: "Company", component: <CompanyDropdown />, path: null },
  ];
                  ...
                  <button
                    ...
                    onClick={() => {
                      if (item.path) {
                        navigate(item.path);
                        closeMobileMenu();
                      } else if (mobileMenuCategories[item.name]) {
      ...
      <nav className="flex items-center justify-between h-16 md:h-20 border-b border-gray-300 relative z-50 px-4 sm:px-6 md:px-8 lg:px-12">
        <div className="flex-shrink-0">
          {mobileMenuOpen && mobileMenuLevel === "category" ? (
            ...
            <Link to="/" className="font-bold text-lg md:text-xl text-blue-600 tracking-tight">
              CryptoApp
            </Link>
          )}
        </div>
